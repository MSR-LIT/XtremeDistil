...
import sys
from student_rnn_soft import generate_sequence_data, train_model
...
flags.DEFINE_string("word_emb_file", None,
                    "Pre-trained word embedding file for initialization.")
...
flags.DEFINE_string("s_opt", 'adam', help="which optimizer to use")
 
flags.DEFINE_string("path", None, help="path of data")

flags.DEFINE_string("task", None, help="name of the task")

flags.DEFINE_integer("distil_batch_size", 64, "batch size for distillation")

flags.DEFINE_string("model_dir", None, help="path of the model directory")
...
def main(_):
  ...
  if FLAGS.do_distil:
    ...
    train_model(FLAGS.max_seq_length, tokenizer.word_index, FLAGS.distil_batch_size, x_train, y_train, x_teacher, y_teacher, y_layer_teacher, x_dev, y_dev, x_test, y_test, FLAGS.word_emb_file, FLAGS.output_dir, dense_hidden_size, FLAGS.s1_loss, FLAGS.s_opt)
